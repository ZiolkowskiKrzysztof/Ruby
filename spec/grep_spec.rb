...
describe Grep do
  ...
  describe "multiple" do
    ...
    it "files several matches no flags" do
      pattern = "may"
      flags = []
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
    ...
    it "files several matches print line numbers flag" do
      pattern = "that"
      flags = ["-n"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
    ...
    it "files one match print file names flag" do
      pattern = "who"
      flags = ["-l"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
      expected = "iliad.txt\nparadise-lost.txt\n".rstrip
    ...
    it "files several matches case insensitive flag" do
      pattern = "TO"
      flags = ["-i"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
    ...
    it "files several matches inverted flag" do
      pattern = "a"
      flags = ["-v"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
    ...
    it "files one match match entire lines flag" do
    ...
    it "files one match multiple flags" do
      pattern = "WITH LOSS OF EDEN, TILL ONE GREATER MAN"
      flags = ["-n", "-i", "-x"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
    ...
    it "files no matches various flags" do
      pattern = "Frodo"
      flags = ["-n", "-l", "-x", "-i"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
      expected = "\n".rstrip
    ...
    it "files several matches file flag takes precedence over line number flag" do
      pattern = "who"
      flags = ["-n", "-l"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
      expected = "iliad.txt\nparadise-lost.txt\n".rstrip
    ...
    it "files several matches inverted and match entire lines flags" do
      pattern = "Illustrious into Ades premature,"
      flags = ["-x", "-v"]
      files = ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"]
